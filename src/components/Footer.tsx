    ...
    <footer className="bg-brand-ink text-brand-bg py-20 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16">
        <div className="md:col-span-8">
          <Link to="/" className="font-serif text-3xl mb-6 block">Vrajesh Shah</Link>
          <p className="text-brand-bg/60 max-w-md mb-12 leading-relaxed text-lg">
            Creative Developer and MarTech Analyst building high-performance marketing infrastructure and editorial digital experiences.
          </p>
          <div className="flex gap-6">
            ...
            <a href="mailto:vrajeshshah13@gmail.com" className="hover:text-brand-bg/40 transition-colors">
              <Mail size={24} />
            </a>
          </div>
        </div>
        ...
        <div className="md:col-span-4">
          ...
          <ul className="space-y-6 text-brand-bg/80 text-sm uppercase tracking-widest mb-12">
            ...
            <li><Link to="/services" className="hover:text-brand-bg transition-colors">TheBoringStack</Link></li>
          ...
          <a href="mailto:vrajeshshah13@gmail.com" className="hover:text-brand-bg transition-colors font-sans text-sm font-medium text-brand-bg/80">
